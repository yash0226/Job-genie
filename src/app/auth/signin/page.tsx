      ...
      <div className="flex min-h-screen relative z-10">
        ...
        <div className="hidden lg:flex lg:w-1/2 text-white p-12 flex-col backdrop-blur-[2px]">
          ...
          <p className="text-lg text-purple-100/90 mb-12">
            Focus on the conversation—get instant guidance, smart prompts, and actionable feedback the moment you need it.
          </p>
        ...
        {/* Right Panel - Sign In Form (dark, translucent) */}
        <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-12 bg-black/10">
          <div className="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p className="text-center text-gray-300 mb-8">
              Sign in to get real-time answers and guidance as you work.
            </p>
            ...
            <p className="mt-8 text-center text-sm text-gray-300">
              ...
              <Link href="/auth/signup" className="font-medium text-purple-300 hover:text-purple-200">
                Sign up for free
              </Link>
            </p>
          </div>
